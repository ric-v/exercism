...
export function dayRate(ratePerHour) {
  return ratePerHour * BILLABLE_HOURS;
}
...
export function priceWithMonthlyDiscount(ratePerHour, numDays, discount) {
  ...
  console.log(monthsInProject, lastDaysWithoutDiscount,
    monthlyRate, remainingDaysCharge, monthlyRate*discount + remainingDaysCharge);
